const portalCopy = {
  service: {
    ...
    storyTitle: '让每一次客户咨询，\n都得到专业回应。',
    storyDescription: '统一会话、知识与人工服务，在安全的租户边界内持续提升客户体验。',
    loginTitle: '登录服务中心',
    loginDescription: '使用客服或客户账号继续访问服务中心。',
    registerTitle: '创建服务中心账号',
    registerDescription: '选择客服或客户身份，开始使用服务与咨询能力。',
    ...
    crossPortal: { href: '/admin/login', label: '前往平台与租户管理系统' },
  ...
  admin: {
    ...
    storyDescription: '统一管理租户、团队与服务配置，在可审计的边界内稳定运营。',
    loginTitle: '登录管理中心',
    loginDescription: '使用平台或机构管理员账号继续访问管理中心。',
    registerTitle: '创建管理中心账号',
    registerDescription: '选择管理员身份，完成平台或机构管理账号注册。',
    ...
    metrics: [['24', '在线租户'], ['78.4%', 'AI 解决率'], ['99.95%', '服务可用性']],
  },
}
